...
.tag-warmup{background:#1A1A1A;color:#FFD700;}  
.tag-mobility{background:#2A4A6A;color:#90C8F0;}  
  ...
  p1:{label:"Phase 1 — Fondations",semaines:"S1–S8",  
    ...
    jours:[  
      {num:1,titre:"UPPER A",sous:"Push + Pull léger + Salle",badge:"push",sections:[  
        {label:"🔥 ÉCHAUFFEMENT (10 min)",tag:"warmup",exos:[  
          {nom:"Rotations poignets (cercles)",sets:"10 × chaque sens",quand:"—",note:"Lent et contrôlé — toujours en premier",prog:""},  
          {nom:"Rotations épaules",sets:"10 avant + 10 arrière",quand:"—",note:"Amplitude maximale",prog:""},  
          {nom:"Rotations hanches",sets:"10 cercles chaque côté",quand:"—",note:"Grands cercles debout",prog:""},  
          {nom:"Cat-cow",sets:"10 reps lentes",quand:"—",note:"Expire en arrondissant, inspire en creusant",prog:""},  
          {nom:"Scapular push-ups",sets:"3 × 8",quand:"—",note:"Bras tendus, omoplates seules bougent",prog:""},  
          {nom:"Dead hang passif barre",sets:"2 × 20–30 sec",quand:"—",note:"Décompression + grip",prog:""},  
          {nom:"Jumping jacks",sets:"30 secondes",quand:"—",note:"Monte le rythme cardiaque",prog:""},  
          {nom:"Squats air",sets:"15 reps",quand:"—",note:"Descente profonde, mobilité hanche",prog:""},  
        ]},  
        {label:"🧘 MOBILITÉ DU JOUR — Chaîne post. + Hanches (S1-2) / Lean planche (S3+)",tag:"mobility",exos:[  
          {nom:"Jefferson curl (sans poids S1-2 / +2kg S3-4 / +4kg S5+)",sets:"3 × 5 reps lentes",quand:"5 sec descente, 5 sec montée",note:"Vertebre par vertebre. Exercice clé de la semaine",prog:"→ Ajouter charge progressivement"},  
          {nom:"Étirement ischio allongé",sets:"3 × 45 sec chaque jambe",quand:"—",note:"Allongé, jambe vers plafond tenue derrière la cuisse",prog:"→ Flexion active sans les mains S3+"},  
          {nom:"Relevés de genoux assis (actif)",sets:"3 × 10 chaque jambe",quand:"S3+: les deux genoux ensemble",note:"Mains sur les côtés SANS s'appuyer",prog:"→ Deux jambes ensemble S3+"},  
          {nom:"Hip flexor stretch en fente",sets:"3 × 45 sec chaque côté",quand:"—",note:"Genou arrière au sol, pousse hanches vers l'avant",prog:"→ Bras levés + rotation buste S3+"},  
        ]},  
      ...
      {num:2,titre:"LOWER + CORE",sous:"Jambes + Gainage + Mobilité",badge:"legs",sections:[  
        {label:"🔥 ÉCHAUFFEMENT (10 min)",tag:"warmup",exos:[  
          {nom:"Rotations chevilles",sets:"10 cercles chaque sens",quand:"—",note:"Chevilles = moteur des squats",prog:""},  
          {nom:"Rotations genoux",sets:"10 cercles chaque sens",quand:"—",note:"Mains sur les genoux, petits cercles",prog:""},  
          {nom:"Rotations hanches",sets:"10 cercles chaque côté",quand:"—",note:"Grands cercles debout",prog:""},  
          {nom:"Squats air lent",sets:"2 × 10",quand:"—",note:"Descente 3 sec, pause 1 sec en bas, remonte",prog:""},  
          {nom:"Hip thrust poids du corps",sets:"2 × 15",quand:"—",note:"Dos au sol, pousse hanches vers le ciel, 2 sec en haut",prog:""},  
          {nom:"Fentes statiques",sets:"1 × 8 chaque jambe",quand:"—",note:"Sur place, descend lentement, remonte",prog:""},  
          {nom:"Good morning sans barre",sets:"1 × 10",quand:"—",note:"Mains nuque, penche buste avant dos droit",prog:""},  
        ]},  
        {label:"🧘 MOBILITÉ DU JOUR — Poignets + Épaules + Planche",tag:"mobility",exos:[  
          {nom:"Wrist warm-up complet",sets:"1 × (enchaîner tout)",quand:"—",note:"Cercles 10/sens · doigts avant 30s · doigts arrière 20s · doigts vers soi 20s",prog:""},  
          {nom:"Protraction scapulaire au sol",sets:"3 × 10 reps lentes",quand:"—",note:"Position pompe, bras tendus, arrondi dos vers ciel. Bras NE plient PAS.",prog:"→ 3×12 S3+"},  
          {nom:"Cat-cow profond",sets:"3 × 10 très lentes",quand:"—",note:"Arrondi TOUT le dos vers le ciel à l'expire",prog:""},  
          {nom:"Hollow body hold",sets:"5 × 15 sec",quand:"S3+: 5×20 sec / S5+: 5×25 sec",note:"Dos plaqué, jambes 60° S1-2 → 45° S3-4 → 30° S5+",prog:"→ Jambes progressivement plus basses"},  
          {nom:"Pseudo planche lean statique (S3+)",sets:"6 × 10 sec",quand:"Introduire semaine 3",note:"S3-4: mains sous épaules · S5+: mains niveau nombril",prog:"→ Mains de plus en plus basses"},  
        ]},  
      ...
      {num:3,titre:"REPOS ACTIF",sous:"Marche 30 min + mobilité 15 min",badge:"rest",sections:[  
        {label:"🧘 MOBILITÉ COMPLÈTE — Hanches + Compression (15 min)",tag:"mobility",exos:[  
          {nom:"90/90 hip stretch",sets:"3 × 45 sec chaque côté",quand:"S3+: 3×60 sec",note:"Assis au sol, jambe avant 90°, jambe arrière 90°, penche-toi vers l'avant",prog:"→ 60 sec S3+"},  
          {nom:"Pigeon pose",sets:"3 × 60 sec chaque côté",quand:"S3+: 3×60 sec",note:"Jambe avant pliée 90°, jambe arrière tendue, buste vers l'avant",prog:"→ Aller plus loin chaque semaine"},  
          {nom:"Compression assis jambes tendues",sets:"3 × 45 sec",quand:"S3+: 3×60 sec avec serviette",note:"Assis, jambes tendues, buste vers l'avant DOS DROIT",prog:"→ Attraper les chevilles puis les pieds"},  
          {nom:"Relevés de genoux debout (actif)",sets:"3 × 10 chaque jambe",quand:"—",note:"Sans aide des mains, maintiens 3 sec en haut",prog:"→ Les deux genoux S3+"},  
          {nom:"World's greatest stretch",sets:"5 reps chaque côté",quand:"—",note:"Fente avant, coude au sol, rotation bras vers le ciel",prog:""},  
          {nom:"Hip 90/90 bascule",sets:"10 reps",quand:"—",note:"Assis, bascule d'un côté à l'autre en douceur",prog:""},  
        ]},  
      ...
      {num:4,titre:"UPPER B",sous:"Pull dominante + Push léger + Salle",badge:"pull",sections:[  
        {label:"🔥 ÉCHAUFFEMENT (10 min)",tag:"warmup",exos:[  
          {nom:"Rotations poignets",sets:"10 cercles chaque sens",quand:"—",note:"Obligatoire avant tractions",prog:""},  
          {nom:"Rotations épaules",sets:"10 avant + 10 arrière",quand:"—",note:"Amplitude maximale",prog:""},  
          {nom:"Scapular push-ups",sets:"3 × 8",quand:"—",note:"Bras tendus, omoplates seules",prog:""},  
          {nom:"Scapular pull-ups (barre)",sets:"3 × 8",quand:"—",note:"Suspendu, hausser/baisser épaules sans plier coudes",prog:""},  
          {nom:"Thread the needle",sets:"8 chaque côté",quand:"—",note:"Rotation thoracique au sol",prog:""},  
          {nom:"Dead hang passif",sets:"2 × 20 sec",quand:"—",note:"Décompression + grip",prog:""},  
          {nom:"Banded pull-apart ou élastique",sets:"2 × 15",quand:"—",note:"Santé épaules préventive",prog:""},  
        ]},  
        {label:"🧘 MOBILITÉ DU JOUR — Repos léger (5 min)",tag:"mobility",exos:[  
          {nom:"Jefferson curl (2 × 5 lent)",sets:"2 × 5",quand:"—",note:"Maintien des acquis — ne pas forcer",prog:""},  
          {nom:"Pigeon pose",sets:"1 × 45 sec chaque côté",quand:"—",note:"Récupération hanches",prog:""},  
          {nom:"Wrist circles",sets:"1 min",quand:"—",note:"Préparation poignets pour les tractions",prog:""},  
        ]},  
        {label:"CALISTHÉNIE (60%)",tag:"cali",exos:[  
      ...
      {num:5,titre:"LOWER + CORE + MOBILITÉ",sous:"Jambes + Core + Étirements 12 min",badge:"legs",sections:[  
        {label:"🔥 ÉCHAUFFEMENT (10 min)",tag:"warmup",exos:[  
          {nom:"Rotations chevilles + genoux",sets:"10 cercles chaque",quand:"—",note:"Mobilisation articulaire complète bas du corps",prog:""},  
          {nom:"Squats air lent",sets:"2 × 10",quand:"—",note:"Descente 3 sec, pause en bas",prog:""},  
          {nom:"Fentes statiques",sets:"1 × 8 chaque",quand:"—",note:"Stabilisateurs de hanche",prog:""},  
          {nom:"Hip thrust poids du corps",sets:"2 × 15",quand:"—",note:"Active les fessiers avant la charge",prog:""},  
          {nom:"Good morning sans barre",sets:"1 × 10",quand:"—",note:"Préchauffe érecteurs et ischio",prog:""},  
          {nom:"World's greatest stretch",sets:"3 reps chaque côté",quand:"—",note:"Mobilité totale en un seul mouvement",prog:""},  
        ]},  
        {label:"🧘 MOBILITÉ DU JOUR — Chaîne post. avancée + L-sit prep",tag:"mobility",exos:[  
          {nom:"Jefferson curl (bouteille 1.5L S1-2 / 3kg S3-4 / 4kg S5+)",sets:"3 × 5 reps",quand:"—",note:"Ajouter charge progressivement chaque phase",prog:"→ Charge croissante"},  
          {nom:"Straddle stretch (écart assis)",sets:"3 × 60 sec",quand:"S3+: pencher sur chaque jambe aussi",note:"Jambes écartées au max, mains au sol",prog:"→ Plus d'amplitude + pencher sur chaque jambe"},  
          {nom:"Tuck L-sit entre deux chaises",sets:"6 × max",quand:"Obj S1-2: 5 sec / S3-4: 10 sec / S5-6: 20 sec",note:"Mains sur chaises, genoux vers poitrine",prog:"→ Objectif croissant par phase"},  
          {nom:"Compression active jambe par jambe",sets:"3 × 8 chaque jambe",quand:"S3+: les deux jambes ensemble",note:"Assis au sol, lève jambe tendue SANS les mains, maintiens 3 sec",prog:"→ Les deux jambes ensemble S3+"},  
          {nom:"Tuck L-sit + une jambe tendue (S3+)",sets:"5 × 5 sec chaque côté",quand:"Introduire semaine 3",note:"En tuck L-sit, tends une jambe en alternance",prog:"→ L-sit deux jambes S5+"},  
        ]},  
  ...
  p2:{label:"Phase 2 — Construction",semaines:"S9–S24",  
    ...
    jours:[  
      {num:1,titre:"PUSH",sous:"Pectoraux + Épaules + Triceps",badge:"push",sections:[  
        {label:"🔥 ÉCHAUFFEMENT (10 min)",tag:"warmup",exos:[  
          {nom:"Rotations poignets",sets:"10 cercles chaque sens",quand:"—",note:"Poignets — séance push intensive",prog:""},  
          {nom:"Rotations épaules + bras croisés",sets:"10 + 10 chaque",quand:"—",note:"Amplitude maximale avant de pousser",prog:""},  
          {nom:"Scapular push-ups",sets:"3 × 8",quand:"—",note:"Activation omoplates",prog:""},  
          {nom:"Pompes inclinées lentes (mains sur banc)",sets:"2 × 10",quand:"—",note:"Mise en route pectoraux + épaules",prog:""},  
          {nom:"Cat-cow",sets:"10 reps",quand:"—",note:"Mobilité thoracique",prog:""},  
          {nom:"Jumping jacks",sets:"30 sec",quand:"—",note:"Cardio léger",prog:""},  
          {nom:"Thread the needle",sets:"6 chaque côté",quand:"—",note:"Rotation thoracique",prog:""},  
        ]},  
        {label:"🧘 MOBILITÉ DU JOUR — Planche + Poignets avancés",tag:"mobility",exos:[  
          {nom:"Wrist warm-up complet",sets:"1 × enchaîné",quand:"—",note:"Cercles + doigts avant 30s + doigts arrière 20s + vers soi 20s",prog:""},  
          {nom:"Pseudo planche lean statique",sets:"6 × 12 sec",quand:"S9-16: mains sous épaules / S17+: mains niveau nombril",note:"Protraction max, lean vers l'avant",prog:"→ Mains progressivement plus basses"},  
          {nom:"Protraction scapulaire au sol",sets:"3 × 12",quand:"—",note:"Bras tendus, arrondi dos vers ciel",prog:""},  
          {nom:"Hollow body hold",sets:"5 × 20 sec",quand:"S17+: 5×25 sec jambes 30°",note:"Base planche et HSPU",prog:"→ Jambes plus basses chaque phase"},  
        ]},  
        {label:"CALISTHÉNIE (60%)",tag:"cali",exos:[  
      ...
      {num:2,titre:"PULL",sous:"Dos + Biceps + Arrière Épaule",badge:"pull",sections:[  
        {label:"🔥 ÉCHAUFFEMENT (10 min)",tag:"warmup",exos:[  
          {nom:"Rotations épaules",sets:"10 avant + 10 arrière",quand:"—",note:"Amplitude maximale",prog:""},  
          {nom:"Scapular pull-ups (barre)",sets:"3 × 8",quand:"—",note:"Suspendu, épaules seules bougent",prog:""},  
          {nom:"Dead hang actif",sets:"2 × 20 sec",quand:"—",note:"Omoplates vers le bas",prog:""},  
          {nom:"Thread the needle",sets:"8 chaque côté",quand:"—",note:"Rotation thoracique",prog:""},  
          {nom:"Face pulls élastique",sets:"2 × 15",quand:"—",note:"Santé épaules préventive",prog:""},  
          {nom:"Banded pull-apart",sets:"2 × 15",quand:"—",note:"Ou bras tendus avec élastique",prog:""},  
        ]},  
        {label:"🧘 MOBILITÉ DU JOUR — Chaîne post. + Compression",tag:"mobility",exos:[  
          {nom:"Jefferson curl (3kg S9-16 / 4kg S17+)",sets:"3 × 5 reps",quand:"—",note:"Vertebre par vertebre, 5 sec descente",prog:"→ Charge croissante"},  
          {nom:"Straddle stretch",sets:"3 × 60 sec",quand:"S17+: pencher sur chaque jambe aussi",note:"Jambes écartées max, mains au sol",prog:"→ Plus d'amplitude"},  
          {nom:"Compression assis jambes tendues",sets:"3 × 60 sec",quand:"—",note:"Buste vers l'avant DOS DROIT, attrape chevilles",prog:"→ Attraper les pieds"},  
          {nom:"Frog stand — SKILLS",sets:"6 × max",quand:"Obj S9-16: 12 sec / S17+: 18 sec",note:"Lean avant, protraction max",prog:"→ Objectif croissant"},  
        ]},  
        {label:"CALISTHÉNIE (60%)",tag:"cali",exos:[  
      ...
      {num:3,titre:"LEGS + CORE",sous:"Jambes lourdes + Gainage avancé",badge:"legs",sections:[  
        {label:"🔥 ÉCHAUFFEMENT (10 min)",tag:"warmup",exos:[  
          {nom:"Rotations chevilles + genoux",sets:"10 cercles chaque",quand:"—",note:"Mobilisation articulaire bas du corps",prog:""},  
          {nom:"Squats air lent",sets:"2 × 10",quand:"—",note:"Descente 3 sec, pause en bas",prog:""},  
          {nom:"Hip thrust poids du corps",sets:"2 × 15",quand:"—",note:"Active fessiers avant la charge",prog:""},  
          {nom:"Fentes statiques",sets:"1 × 8 chaque",quand:"—",note:"Stabilisateurs de hanche",prog:""},  
          {nom:"World's greatest stretch",sets:"3 reps chaque côté",quand:"—",note:"Mobilité totale en un seul mouvement",prog:""},  
          {nom:"Romanian deadlift sans barre",sets:"1 × 10",quand:"—",note:"Préchauffe ischio + érecteurs",prog:""},  
        ]},  
        {label:"🧘 MOBILITÉ DU JOUR — L-sit + Compression avancée",tag:"mobility",exos:[  
          {nom:"90/90 hip stretch",sets:"3 × 60 sec chaque côté",quand:"—",note:"Jambe avant 90°, jambe arrière 90°, penche-toi vers l'avant",prog:"→ Aller plus loin chaque semaine"},  
          {nom:"Pigeon pose",sets:"3 × 60 sec chaque côté",quand:"—",note:"Jambe avant 90°, jambe arrière tendue, buste vers l'avant",prog:"→ Plus profond chaque phase"},  
          {nom:"Tuck L-sit entre chaises",sets:"6 × max",quand:"Obj S9-16: 10 sec / S17+: 20 sec",note:"Progression continue",prog:"→ Objectif croissant"},  
          {nom:"L-sit une jambe tendue",sets:"5 × 5 sec chaque",quand:"S17+: objectif 8 sec",note:"En tuck L-sit, tends une jambe en alternance",prog:"→ Les deux jambes S17+"},  
          {nom:"Compression active deux jambes",sets:"5 × 5 sec",quand:"—",note:"Assis au sol, lève les deux jambes tendues quelques cm sans les mains",prog:"→ Hauteur croissante"},  
        ]},  
      ...
      {num:4,titre:"REPOS ACTIF",sous:"Mobilité + Skills légers",badge:"rest",sections:[  
        {label:"🧘 MOBILITÉ COMPLÈTE — Full corps (20 min)",tag:"mobility",exos:[  
          {nom:"Jefferson curl (4kg)",sets:"3 × 5",quand:"—",note:"Maintien des acquis — ne pas forcer",prog:""},  
          {nom:"Pigeon pose",sets:"2 × 60 sec chaque côté",quand:"—",note:"Récupération hanches",prog:""},  
          {nom:"Straddle stretch",sets:"2 × 60 sec",quand:"—",note:"Maintien amplitude",prog:""},  
          {nom:"Hollow body hold",sets:"3 × 20 sec",quand:"—",note:"Maintien activation abdos",prog:""},  
          {nom:"Wrist circles",sets:"1 min",quand:"—",note:"Entretien poignets",prog:""},  
          {nom:"Hip 90/90 bascule",sets:"10 reps",quand:"—",note:"Mobilité hanches active",prog:""},  
        ]},  
        {label:"RÉCUPÉRATION",tag:"core",exos:[  
          {nom:"Marche légère",sets:"20–30 min",quand:"—",note:"FC <130 bpm, récupération active",prog:""},  
          {nom:"Frog stand ou Handstand — léger",sets:"5 × max à 50%",quand:"—",note:"Sensation uniquement — pas d'effort maximal",prog:""},  
        ]},  
      ]},  
      {num:5,titre:"PUSH + SKILLS",sous:"Push hypertrophie + Planche/HSPU",badge:"skills",sections:[  
        {label:"🔥 ÉCHAUFFEMENT (10 min)",tag:"warmup",exos:[  
          {nom:"Rotations poignets complet",sets:"10 cercles chaque sens",quand:"—",note:"Critique avant skills planche",prog:""},  
          {nom:"Rotations épaules + bras pendule",sets:"10 + 10",quand:"—",note:"Amplitude totale",prog:""},  
          {nom:"Scapular push-ups",sets:"3 × 8",quand:"—",note:"Activation omoplates",prog:""},  
          {nom:"Cat-cow profond",sets:"10 reps",quand:"—",note:"Mobilité thoracique",prog:""},  
          {nom:"Wall slides (dos au mur)",sets:"2 × 10",quand:"—",note:"Activation trapèzes inférieurs",prog:""},  
          {nom:"Hollow body hold",sets:"2 × 15 sec",quand:"—",note:"Activation gainage pré-skills",prog:""},  
        ]},  
        {label:"🧘 MOBILITÉ DU JOUR — Planche avancée + Handstand",tag:"mobility",exos:[  
          {nom:"Pseudo planche lean (mains niveau nombril S9-16 / hanches S17+)",sets:"6 × 15 sec",quand:"—",note:"Protraction maximale, lean maximum",prog:"→ Mains progressivement plus basses"},  
          {nom:"Frog stand — objectif séance",sets:"8 × max",quand:"Obj S9-16: 15 sec / S17+: 22 sec",note:"Progression chaque séance",prog:"→ Objectif croissant"},  
          {nom:"Handstand contre mur — alignement",sets:"6 × max",quand:"Obj S9-16: 20 sec / S17+: 30 sec",note:"Corps droit, oreilles entre les bras",prog:"→ Sorties progressives"},  
        ]},  
      ...
      {num:6,titre:"PULL + SKILLS",sous:"Pull volume + Front lever / L-sit",badge:"skills",sections:[  
        {label:"🔥 ÉCHAUFFEMENT (10 min)",tag:"warmup",exos:[  
          {nom:"Rotations épaules",sets:"10 avant + 10 arrière",quand:"—",note:"Amplitude maximale",prog:""},  
          {nom:"Scapular pull-ups",sets:"3 × 8",quand:"—",note:"Barre, épaules seules bougent",prog:""},  
          {nom:"Dead hang actif",sets:"2 × 20 sec",quand:"—",note:"Omoplates vers le bas",prog:""},  
          {nom:"Face pulls élastique",sets:"2 × 15",quand:"—",note:"Santé épaules",prog:""},  
          {nom:"Jefferson curl léger",sets:"2 × 5",quand:"—",note:"Maintien souplesse chaîne postérieure",prog:""},  
          {nom:"Thread the needle",sets:"6 chaque côté",quand:"—",note:"Rotation thoracique",prog:""},  
        ]},  
        {label:"🧘 MOBILITÉ DU JOUR — L-sit + Front lever prep",tag:"mobility",exos:[  
          {nom:"Compression assis jambes tendues",sets:"3 × 60 sec",quand:"—",note:"Buste vers l'avant, dos droit, attrape les pieds",prog:"→ Pieds puis sol progressivement"},  
          {nom:"L-sit une jambe tendue",sets:"5 × max chaque",quand:"Obj: 8 sec chaque côté",note:"En tuck L-sit, tends une jambe en alternance",prog:"→ L-sit deux jambes S17+"},  
          {nom:"Straddle stretch avec penche latéral",sets:"3 × 45 sec chaque direction",quand:"—",note:"Centre + chaque jambe",prog:"→ Plus d'amplitude"},  
          {nom:"Skin the cat → compression",sets:"4 × 3–5",quand:"—",note:"Rotation fluide, épaules mobiles",prog:""},  
        ]},  
  ...
  p3:{label:"Phase 3 — Élite",semaines:"S25–S52",  
    ...
    jours:[  
      {num:1,titre:"PUSH HEAVY",sous:"Force + Hypertrophie pec/épaules/triceps",badge:"push",sections:[  
        {label:"🔥 ÉCHAUFFEMENT (10 min)",tag:"warmup",exos:[  
          {nom:"Rotations poignets complet",sets:"10 chaque sens",quand:"—",note:"Essentiel avant charges lourdes",prog:""},  
          {nom:"Rotations épaules + windmill",sets:"10 + 10",quand:"—",note:"Amplitude maximale",prog:""},  
          {nom:"Scapular push-ups",sets:"3 × 8",quand:"—",note:"Activation omoplates",prog:""},  
          {nom:"Pompes lentes inclinées",sets:"2 × 10",quand:"—",note:"Mise en route pec + épaules",prog:""},  
          {nom:"Band pull-apart",sets:"3 × 15",quand:"—",note:"Stabilité épaules avant lest",prog:""},  
          {nom:"Hollow body hold",sets:"2 × 20 sec",quand:"—",note:"Activation gainage",prog:""},  
        ]},  
        {label:"🧘 MOBILITÉ DU JOUR — Planche avancée (lean mains hanches)",tag:"mobility",exos:[  
          {nom:"Wrist warm-up complet + wrist push-ups",sets:"2 min total",quand:"—",note:"Poignets sous charge lourde — critique",prog:""},  
          {nom:"Pseudo planche lean mains au niveau hanches",sets:"6 × 15 sec",quand:"→ planche push-up",note:"Protraction maximale, corps horizontal",prog:"→ Planche push-up complet"},  
          {nom:"Hollow body jambes 20°",sets:"5 × 25 sec",quand:"—",note:"Gainage maximal pré-force",prog:"→ Jambes plus basses"},  
          {nom:"Shoulder CARs (rotations contrôlées articulaires)",sets:"5 cercles lents chaque épaule",quand:"—",note:"Santé épaule sous charges maximales",prog:""},  
        ]},  
      ...
      {num:2,titre:"PULL HEAVY",sous:"Force + Hypertrophie dos/biceps",badge:"pull",sections:[  
        {label:"🔥 ÉCHAUFFEMENT (10 min)",tag:"warmup",exos:[  
          {nom:"Rotations épaules complètes",sets:"10 avant + 10 arrière",quand:"—",note:"Amplitude maximale",prog:""},  
          {nom:"Dead hang actif",sets:"3 × 20 sec",quand:"—",note:"Décompression + grip",prog:""},  
          {nom:"Scapular pull-ups",sets:"3 × 8",quand:"—",note:"Activation omoplates avant tractions lourdes",prog:""},  
          {nom:"Face pulls élastique",sets:"3 × 15",quand:"—",note:"Santé épaules pré-charge",prog:""},  
          {nom:"Skin the cat léger",sets:"3 × 3",quand:"—",note:"Mobilité épaules complète",prog:""},  
          {nom:"Rotations poignets",sets:"10 chaque sens",quand:"—",note:"Grip sous charge",prog:""},  
        ]},  
        {label:"🧘 MOBILITÉ DU JOUR — Chaîne post. + Front lever prep",tag:"mobility",exos:[  
          {nom:"Jefferson curl 4kg",sets:"3 × 5",quand:"—",note:"Maintien souplesse chaîne postérieure",prog:"→ Amplitude maximale"},  
          {nom:"Straddle stretch + penché chaque jambe",sets:"3 × 60 sec chaque direction",quand:"—",note:"Amplitude maximale — prépare front lever straddle",prog:""},  
          {nom:"Compression assis jambes tendues",sets:"3 × 60 sec",quand:"—",note:"Buste vers avant, dos droit",prog:"→ Paumes au sol objectif"},  
          {nom:"Frog stand elite",sets:"6 × max",quand:"Obj: 20–25 sec",note:"Consolidation avant planche avancée",prog:"→ Tuck planche barre"},  
        ]},  
        {label:"CALISTHÉNIE FORCE (60%)",tag:"cali",exos:[  
      ...
      {num:3,titre:"LEGS + CORE AVANCÉ",sous:"Legs lourds + Dragon flag + Core",badge:"legs",sections:[  
        {label:"🔥 ÉCHAUFFEMENT (10 min)",tag:"warmup",exos:[  
          {nom:"Rotations chevilles + hanches",sets:"10 chaque sens",quand:"—",note:"Mobilisation articulaire bas du corps",prog:""},  
          {nom:"Squats air profonds lents",sets:"2 × 10",quand:"—",note:"Descente 4 sec, pause en bas",prog:""},  
          {nom:"Hip thrust poids du corps",sets:"2 × 15",quand:"—",note:"Active fessiers avant charges lourdes",prog:""},  
          {nom:"World's greatest stretch",sets:"5 reps chaque côté",quand:"—",note:"Mobilité totale",prog:""},  
          {nom:"Nordic hamstring curl négatif lent",sets:"2 × 3",quand:"—",note:"Préchauffe ischio avant deadlift lourd",prog:""},  
          {nom:"Good morning barre légère",sets:"1 × 10",quand:"—",note:"Érecteurs + ischio",prog:""},  
        ]},  
        {label:"🧘 MOBILITÉ DU JOUR — L-sit avancé + Core compression",tag:"mobility",exos:[  
          {nom:"90/90 hip stretch",sets:"3 × 60 sec chaque côté",quand:"—",note:"Hanches = base de tous les skills Phase 3",prog:""},  
          {nom:"Pigeon pose profond",sets:"3 × 60 sec chaque côté",quand:"—",note:"Aller plus profond qu'en Phase 2",prog:""},  
          {nom:"L-sit → V-sit progression",sets:"5 × max",quand:"Obj: L-sit 20 sec, V-sit 5 sec",note:"Compression maximale",prog:"→ V-sit complet"},  
          {nom:"Compression active deux jambes",sets:"5 × 8 sec",quand:"—",note:"Lève les deux jambes tendues sans les mains",prog:"→ Hauteur croissante"},  
        ]},  
      ...
      {num:4,titre:"⭐ SKILLS DAY",sous:"LA séance la plus importante du programme",badge:"skills",sections:[  
        {label:"🔥 ÉCHAUFFEMENT SKILLS (15 min)",tag:"warmup",exos:[  
          {nom:"Wrist warm-up complet",sets:"3 min total",quand:"—",note:"Le plus important de la semaine — ne jamais sauter",prog:""},  
          {nom:"Rotations épaules + Shoulder CARs",sets:"10 + 5 cercles lents",quand:"—",note:"Épaules mobilisées pour TOUS les skills",prog:""},  
          {nom:"Scapular push-ups + pull-ups",sets:"3 × 8 chaque",quand:"—",note:"Activation omoplates complète",prog:""},  
          {nom:"Hollow body hold",sets:"3 × 20 sec",quand:"—",note:"Base de tous les skills",prog:""},  
          {nom:"Cat-cow profond",sets:"10 reps",quand:"—",note:"Mobilité thoracique",prog:""},  
          {nom:"Dead hang actif",sets:"2 × 30 sec",quand:"—",note:"Décompression + activation grip",prog:""},  
          {nom:"Jefferson curl 2 × 5",sets:"2 × 5",quand:"—",note:"Chaîne postérieure — base des skills",prog:""},  
        ]},  
        {label:"🧘 MOBILITÉ SKILLS — Full 20 min",tag:"mobility",exos:[  
          {nom:"Straddle stretch complet",sets:"3 × 60 sec centre + chaque jambe",quand:"—",note:"Prépare front lever straddle + back lever",prog:""},  
          {nom:"Pigeon pose",sets:"2 × 60 sec chaque côté",quand:"—",note:"Mobilité hanches pour L-sit et planche",prog:""},  
          {nom:"Compression active deux jambes",sets:"5 × 8 sec",quand:"—",note:"Fléchisseurs pour L-sit et V-sit",prog:""},  
          {nom:"Hip 90/90 bascule",sets:"10 reps lentes",quand:"—",note:"Hanches mobiles pour les skills au sol",prog:""},  
        ]},  
      ...
      {num:5,titre:"PUSH VOLUME",sous:"Hypertrophie + Explosivité",badge:"push",sections:[  
        {label:"🔥 ÉCHAUFFEMENT (10 min)",tag:"warmup",exos:[  
          {nom:"Rotations poignets + épaules",sets:"10 chaque sens",quand:"—",note:"Mise en route complète",prog:""},  
          {nom:"Scapular push-ups",sets:"3 × 8",quand:"—",note:"Activation omoplates",prog:""},  
          {nom:"Pompes inclinées lentes",sets:"2 × 10",quand:"—",note:"Mise en route pec",prog:""},  
          {nom:"Cat-cow",sets:"10 reps",quand:"—",note:"Mobilité thoracique",prog:""},  
          {nom:"Jumping jacks",sets:"30 sec",quand:"—",note:"Cardio léger",prog:""},  
        ]},  
        {label:"🧘 MOBILITÉ DU JOUR — Pseudo planche + Handstand prep",tag:"mobility",exos:[  
          {nom:"Pseudo planche lean mains hanches → planche push-up",sets:"6 × 15 sec",quand:"→ Planche push-up complet",note:"Niveau maximum de lean",prog:"→ Full planche S44+"},  
          {nom:"Handstand contre mur — sorties progressives",sets:"6 × max",quand:"Obj: 30 sec stable → 5 sec free S40+",note:"Travaille les sorties du mur",prog:"→ Freestanding"},  
          {nom:"Wrist push-ups",sets:"3 × 8",quand:"—",note:"Renforcement poignets pour charge lestée",prog:""},  
        ]},  
      ...
      {num:6,titre:"PULL VOLUME",sous:"Volume + Définition + Isolation",badge:"pull",sections:[  
        {label:"🔥 ÉCHAUFFEMENT (10 min)",tag:"warmup",exos:[  
          {nom:"Rotations épaules",sets:"10 avant + 10 arrière",quand:"—",note:"Amplitude maximale",prog:""},  
          {nom:"Dead hang actif",sets:"2 × 20 sec",quand:"—",note:"Activation grip",prog:""},  
          {nom:"Scapular pull-ups",sets:"3 × 8",quand:"—",note:"Activation omoplates",prog:""},  
          {nom:"Face pulls élastique",sets:"2 × 15",quand:"—",note:"Santé épaules",prog:""},  
          {nom:"Thread the needle",sets:"6 chaque côté",quand:"—",note:"Rotation thoracique",prog:""},  
        ]},  
        {label:"🧘 MOBILITÉ DU JOUR — L-sit → V-sit + Compression max",tag:"mobility",exos:[  
          {nom:"Compression assis paumes au sol (objectif Phase 3)",sets:"3 × 60 sec",quand:"—",note:"Paumes au sol = objectif S52",prog:"→ Paumes au sol"},  
          {nom:"L-sit → V-sit tentative",sets:"5 × max",quand:"Obj: L-sit 20 sec, V-sit 10 sec",note:"Compression maximale",prog:"→ V-sit complet S48+"},  
          {nom:"Straddle L-sit (tentative S40+)",sets:"4 × max",quand:"Jambes écartées en L-sit",note:"Level supérieur du L-sit",prog:"→ Straddle L-sit"},  
          {nom:"Jefferson curl 4kg",sets:"2 × 5",quand:"—",note:"Maintien chaîne postérieure",prog:""},  
        ]},  
...
function renderSeanceView(dayIdx){  
  ...
  jour.sections.forEach(sec=>{  
    const tagClass={cali:'tag-cali',salle:'tag-salle',skills:'tag-skills',core:'tag-core',warmup:'tag-warmup',mobility:'tag-mobility'}[sec.tag]||'tag-cali';  
    const tagLabel={cali:'Calisthénie',salle:'Salle Basic Fit',skills:'⭐ Skills',core:'Core',warmup:'🔥 Échauffement',mobility:'🧘 Mobilité'}[sec.tag]||'';  
